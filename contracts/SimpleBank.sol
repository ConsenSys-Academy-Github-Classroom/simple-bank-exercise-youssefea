...
contract SimpleBank {
    ...
    function deposit() payable public returns (uint) {
      // 1. Add the appropriate keyword so that this function can receive ether -- done
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      require(withdrawAmount<=balances[msg.sender],"You dont have enough money in the bank!");
